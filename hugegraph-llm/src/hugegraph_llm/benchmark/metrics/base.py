...
class BaseMetric(ABC):
    ...
    `higher_is_better` or by overriding `is_higher_is_better()`. Set
    ``deprecated = True`` on metrics retained for backward compatibility but
    not recommended for new evaluations.
    """
